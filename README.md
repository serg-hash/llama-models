...
## Riemann Zeta Zero Verification

A script is available to check that the first N non-trivial zeros of the Riemann zeta function lie on the critical line. It also plots these zeros.

```bash
python scripts/verify_riemann_zeros.py 20 --output zeros.png
```
